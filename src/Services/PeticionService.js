...
export class PeticionService {
    ...
    getPeticionById = async (id) => {
        try{
            ...
            let query=`SELECT Profesor.nombre, Profesor.apellido, Peticion.horario, Alumno.nombre as anombre, Peticion.descripcion, Peticion.horario, Peticion.Estado, TipoEstado.nombre from Peticion inner join Alumno on Peticion.idAlumno=Alumno.id inner join Profesor on Peticion.idProfesor=Profesor.id TipoEstado on Peticion.Estado=TipoEstado.id where idPeticion = ?`;
